...
export default async function ArticlePage({ params }) {
    ...
    return (
        <div className={styles.theUltimateWrapper}>
            <Navbar />
            <div className={styles.articleWrapper}>

                <aside className={styles.sidebar}>

                    <img src={article.authorImage || "/images/23.jpg"} alt={article.author} />
                    <p>{article.author}</p>
                    <p>{article.authorBio || "Doctor's credentials and short bio..."}</p>
                    ...
                    <div className="ads">
                        <img src="/images/AdsPortrait.jpg" alt="" />
                        <img src="/images/AdsSquare.jpg" alt="" />
                    </div>
                </aside>

                <article className={styles.actualArticle}>
                        ...
                        {Array.isArray(article.content) &&
                            article.content.map((block, index) => {
                                ...
                                if (block.type === "image") {
                                    return (
                                        <div key={index} className={styles.imageBlock}>
                                            <img src={block.src} alt={block.alt || `image-${index}`} />
                                            {block.caption && (
                                ...
                                if (block.type === "separator") {
                                    return (
                                        <p key={index} className={styles.separator}>
                                            _____________________________________________________________________________
                                        </p>
                                    );
                                }
                    ...
                    {article.resources?.length > 0 && (
                        <div className={styles.resources}>
                            <p>Les ressources mentionnées:</p>
                            <ul>
